    ...
    if(isLoaded) {
        ...
        while((col <= ui->tableWidget->columnCount()) && (stopLoading == false))
        {
            ...
            while((row <= ui->tableWidget->rowCount()) && (row <= presentRows))
            {
                ...
                //if((sheet->querySubObject("Cells(int,int)",row,col)->dynamicCall("Value()").toString()) == "")
                //{
                //   break;
                //}
...
void MainWindow::on_actionSelectColumns_triggered()
{

}

void MainWindow::on_actionTypeOfCharts_triggered()
{
...
void MainWindow::on_actionReport_a_Problem_triggered()
{
